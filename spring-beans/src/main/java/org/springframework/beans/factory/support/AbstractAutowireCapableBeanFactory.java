...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	 ...
	 * @see #doCreateBean
	 */
	// 第三个参数 args 数组代表创建实例需要的参数，就是给构造方法用的参数，或者是工厂 Bean 的参数，但在初始化阶段，args 是 null。
	@Override
	...
	protected Object doCreateBean(String beanName, RootBeanDefinition mbd, @Nullable Object[] args)
		...
		try {
			...
			// 初始化bean，过程如下：
			// 1、判断是否实现了BeanNameAware，BeanClassLoaderAware，BeanFactoryAware方法，如果有，则设置相关属性
	...
	protected void applyMergedBeanDefinitionPostProcessors(RootBeanDefinition mbd, Class<?> beanType, String beanName) {
		for (BeanPostProcessor bp : getBeanPostProcessors()) {
			if (bp instanceof MergedBeanDefinitionPostProcessor) {
				...
				// 重点关注AutowireAnnotationBeanPostProcessor,该类会把@Autowired等标记的
	...
	protected void invokeInitMethods(String beanName, Object bean, @Nullable RootBeanDefinition mbd)
		...
		//判断该bean是否实现了实现了InitializingBean接口，如果实现了InitializingBean接口，则掉调用bean的afterPropertiesSet方法
